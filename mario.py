...
goomba_sprites = ['goomba1.gif','goomba2.gif']

mario_jump_right = ['mariojump1.gif']
mario_jump_left = ['mariojump2.gif']

mario_right = ['marioright1.gif','marioright2.gif','marioright3.gif']
mario_left = ['marioleft1.gif','marioleft2.gif','marioleft3.gif']
mario_stay = ['mariostay.gif']

lucky = ['lucky1.png','lucky2.png','lucky3.png']
        ...
        for block in lucky_blocks:
            if pygame.sprite.collide_rect(self,block):
                ...
                if speed_y < 0:
                    self.rect.top = block.rect.bottom
                    self.speed_y = 0
                    block0 = GameSprite('block.png', block.rect.x, block.rect.y,32,32)
                    blocks.add(block0)
                    block.kill()
...
#goomba
goomba1 = Goomba('dead_goomba.gif',640,384,32,32,-2,0)
enemies.add(goomba1)
...
for i in range(640,800,32):
    if count == 1 or count == 3:
        ...
        block = GameSprite('brick_block4.png',i,288,32,32)
        blocks.add(block)
    count += 1
...
#first pipe
pipe1 = GameSprite('pipe2.png',896,352,64,64)
blocks.add(pipe1)
    
#second pipe
pipe2 = GameSprite('pipe3.png',1216,320,64,96)
blocks.add(pipe2)

#goomba
goomba2 = Goomba('dead_goomba.gif',1300,384,32,32,-2,0)
enemies.add(goomba2)

#thirst pipe
pipe3 = GameSprite('pipe3.png',1472,288,64,128)
blocks.add(pipe3)

goomba = Goomba('dead_goomba.gif',1550,384,32,32,-2,0)
goomba1 = Goomba('dead_goomba.gif',1600,384,32,32,-2,0)
enemies.add(goomba)
enemies.add(goomba1)

#four pipe
pipe4 = GameSprite('pipe3.png',1824,288,64,128)
blocks.add(pipe4)
...
goomba1 = Goomba('dead_goomba.gif',2528,256,32,32,-2,0)
goomba2 = Goomba('dead_goomba.gif',2600,128,32,32,-2,0)
enemies.add(goomba1)
enemies.add(goomba2)

#8 blocks
for i in range(2560,2721,32):
    block = GameSprite('brick_block4.png',i,160,32,32)
    blocks.add(block)
...
for i in range(2848,2945,32):
    if count == 3:
        block = GameSprite('lucky_block.png',i,160,32,32)
        lucky_blocks.add(block)
    else:
        block = GameSprite('brick_block4.png',i,160,32,32)
        blocks.add(block)
...
block = GameSprite('brick_block4.png',2944,288,32,32)
blocks.add(block)

goomba = Goomba('dead_goomba.gif',3000,384,32,32,-2,0)
goomba1 = Goomba('dead_goomba.gif',3036,384,32,32,-2,0)
enemies.add(goomba)
enemies.add(goomba1)
...
lucky_block = GameSprite('lucky_block.png',3328,288,32,32)
lucky_blocks.add(lucky_block)
lucky_block = GameSprite('lucky_block.png',3424,288,32,32)
lucky_blocks.add(lucky_block)
lucky_block = GameSprite('lucky_block.png',3520,288,32,32)
lucky_blocks.add(lucky_block)
lucky_block = GameSprite('lucky_block.png',3424,160,32,32)
lucky_blocks.add(lucky_block)

goomba = Goomba('dead_goomba.gif',3530,384,32,32,-2,0)
goomba1 = Goomba('dead_goomba.gif',3570,384,32,32,-2,0)
enemies.add(goomba)
enemies.add(goomba1)

brick_block = GameSprite('brick_block4.png',3712,288,32,32)
blocks.add(brick_block)

for i in range(3808,3904,32):
    brick_block = GameSprite('brick_block4.png',i,160,32,32)
    blocks.add(brick_block)

goomba = Goomba('dead_goomba.gif',3905,384,32,32,-2,0)
goomba1 = Goomba('dead_goomba.gif',3938,384,32,32,-2,0)
enemies.add(goomba)
enemies.add(goomba1)
...
goomba = Goomba('dead_goomba.gif',4062,384,32,32,-2,0)
goomba1 = Goomba('dead_goomba.gif',4096,384,32,32,-2,0)
enemies.add(goomba)
enemies.add(goomba1)
...
for i in range(4224,4321,32):
    block = GameSprite('block.png',i,384,32,32)
    blocks.add(block)
for i in range(4256,4321,32):
    block = GameSprite('block.png',i,352,32,32)
    blocks.add(block)
for i in range(4288,4321,32):
    block = GameSprite('block.png',i,320,32,32)
    blocks.add(block)
block = GameSprite('block.png',4320,288,32,32)
blocks.add(block)



block = GameSprite('block.png',4416,288,32,32)
blocks.add(block)
...
for i in range(4768,4801,32):
    block = GameSprite('block.png',i,288,32,32)
    blocks.add(block)
...
block = GameSprite('block.png',4896,288,32,32)
blocks.add(block)
...
pipe = GameSprite('pipe2.png',5152,352,64,64)
blocks.add(pipe)

goomba = Goomba('dead_goomba.gif',5220,384,32,32,-2,0)
goomba1 = Goomba('dead_goomba.gif',5260,384,32,32,-2,0)
enemies.add(goomba)
enemies.add(goomba1)
...
pipe2 = GameSprite('pipe2.png',5664,352,64,64)
blocks.add(pipe2)
...
for i in range(5856,6016,32):
    block = GameSprite('block.png',i,256,32,32)
    blocks.add(block)
for i in range(5888,6016,32):
    block = GameSprite('block.png',i,224,32,32)
    blocks.add(block)
for i in range(5920,6016,32):
    block = GameSprite('block.png',i,192,32,32)
    blocks.add(block)
for i in range(5952,6016,32):
    block = GameSprite('block.png',i,160,32,32)
    blocks.add(block)

flag_block = GameSprite('block.png',6272,384,32,32)
blocks.add(flag_block)
flag = GameSprite('flag.png',6235,64,64,320)
blocks.add(flag)

#################################

player = Player('mariostay.gif',80,384,32,32,0,0) #32,43
